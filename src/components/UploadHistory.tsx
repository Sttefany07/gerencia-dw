  ...
  const exportActiveData = () => {
    ...
    exportRowsToExcel(
      ...
      [
        ...
        { header: "Hito facturable", value: (row) => row.hitoFacturable },
        { header: "Rol estimado", value: (row) => row.rolEstimado },
        { header: "Rol asignado", value: (row) => row.rolAsignado },
        { header: "Persona", value: (row) => row.persona },
        { header: "Horas estimadas", value: (row) => row.horasEstimadas },
        { header: "Horas registradas", value: (row) => row.horasRegistradas },
        { header: "Horas facturables", value: (row) => row.horasFacturables },
